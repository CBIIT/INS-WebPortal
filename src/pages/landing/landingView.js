              ...
              <div className={classes.mobileTiles}>
                ...
                <div className={classes.content}>
                  <div className={classes.contentHeader}>
                    About the Index of NCI Studies
                  </div>
                  <div className={classes.contentContainer}>
                    The goal of the Index of NCI Studies (INS) is to enable access to information about the large amount of data generated by NCI-supported studies so that NCI leadership, cancer researchers, and the public can rapidly assess the state of science at a single location.
                  </div>
                </div>
                <div className={classes.yellowButton}>
                  <div className={classes.yellowButtonLeft}>
